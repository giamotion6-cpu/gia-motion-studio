...
export const trustedClients = [
  {
    ...
    items: [
      { name: "Municipalidad Provincial de Cajamarca", logo: "/images/empresas/municipalidad.png" },
      { name: "Real Plaza", logo: "/images/empresas/real_plaza.png" },
      { name: "Yamaha", logo: "/images/empresas/yamaha.png" },
      { name: "Honda", logo: "/images/empresas/logo_honda.png" },
      { name: "Chevrolet", logo: "/images/empresas/chevrolet.png" },
      { name: "MSA Automotriz", logo: "/images/empresas/logo_msa.png" },
  ...
  },
  {
    title: "Minería",
    items: [
      { name: "Shauindo American Pan Silver", logo: "/images/empresas/pan_american.png" },
      { name: "Goldfields", logo: "/images/empresas/gold_fields.png" },
      { name: "Newmont Yanacocha", logo: "/images/empresas/yanacocha.png" },
    ],
  },
